...
$domain = $domain?$domain:'tool.zznet.cn';
...
<title><?php echo $domain;?>的网站综合信息信息 - 站长查询网</title>
<body>
<div class="main">
  <div class="box">
    <div id="c">
...
<script type="text/javascript">/*468*60，创建于2010-12-22*/ var cpro_id = 'u323720';</script><script src="http://cpro.baidu.com/cpro/ui/c.js" type="text/javascript"></script>
</div>
  </div>
...
<br/>
<table border="1" width="100%" bordercolordark="#FFFFFF" cellspacing="0" cellpadding="0" bordercolorlight="#BBD7E6"><tr bgcolor=#D8F0FC><td colspan="4">网址<a href="<?php echo "http://www.".$domain?>"><?php echo "http://".$domain?></a>META信息检测结果如下:</td></tr>
...
foreach ($urls as $key=>$v){
	echo "<a href=http://tool.zznet.cn/seo/alls.php?domain=".$urls[$key].">".$urls[$key]."</a>&nbsp;&nbsp;";
}}?></td></tr>
</table>
</span>
</div>
