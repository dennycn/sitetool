...
<li>网站信息查询(IE):
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/pr/pr.php"?> target="_self"  class="imt">Google PR查询</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/ssyqsl/ssyqsl.php"?> target="_self"  class="imt">收录查询</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/ssyqfl/ssyqfl.php"?> target="_self"  class="imt">反向链接查询</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/webs/webs.php?domain="?> target="_self"  class="imt">死链接检测/全站PR查询</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/pr/outpr.php"?> target="_self" >PR输出值查询</a></li></ul>
<ul class="toolist">
<li>搜索优化查询(IE):
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/friends/friends.php"?> target="_self"  class="imt">友情链接检测</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/keys/keys.php"?> target="_self"   class="imt">关键词排名查询</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/density.php"?> target="_self"  class="imt">关键词密度查询</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/esearch.php"?> target="_self"  class="imt">搜索引擎模拟</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/meta.php"?> target="_self" >网页META信息</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/baidu/baidu.php"?> target="_self"  class="imt">百度收录</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/google/google.php"?> target="_self" >Google收录</a></li></ul>
<ul class="toolist">
<li>域名/IP类查询：
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/whois/"?> target="_self"  class="imt">域名WHOIS查询</a><//li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/dels/dels.php"?> target="_self"  class="imt">域名删除时间</a><//li><li>-</li>
...
<ul class="toolist">
<li>生活实用查询：
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/ids.php"?> target="_self"  >身份证号码查询</a></li><li>-</li>
...
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/search/train.html"?> target="_blank" class="imr">列车时刻查询</a></li></ul>
<ul class="toolist">
<li>其它实用工具：
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/huoxing/"?> target="_self" class="imr">火星文转换</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/naojin/"?> target="_blank" class="imr">脑筋急转弯</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/finance/"?> target="_blank" class="imr">财务工具</a></li><li>-</li>
<li><a href=<?php echo "http://".$_SERVER['SERVER_NAME']."/sitetool/gangqin/"?> target="_blank" class="imr">钢琴键盘</a></li></ul>
