...
if($prescription!=""){
	...
	$pf_l = '<table width="700" cellpadding="2" cellspacing="0" class="mob_ace" style="border:1px solid #A4C4DC;"><tr><td style="background:url(/img/kuang5.gif);padding:0 5px;color:#014198;" height="26" valign="middle" colspan="5"><b><a href="./">周公解梦</a>：找到 <a href="./?q='.urlencode($prescription).'"><font color="#c60a00">'.$prescription.'</font></a> 的相关解梦'.$r_num.'个</b></td></tr><tr><td><table cellpadding="5" cellspacing="10" width="100%">'.$pf_l.'</table></td></tr></table>';
}elseif($id>0){
	$dreamdb=file("data/jm.dat");//读取解梦文件
	$count=count($dreamdb);//计算行数
...
<table width="700" cellpadding="2" cellspacing="0" style="border:1px solid #A4C4DC;" id="top"><tr><td align="center" valign="middle" height="60"><form action="./" method="get" name="f1"><b>搜索解梦：<b><input name="q" id="q" type="text" size="18" delay="0" value="" style="width:200px;height:22px;font-size:16px;font-family: Geneva, Arial, Helvetica, sans-serif;" /> <input type="submit" class="mob_copy1" value=" 搜索 " /></td></tr><tr><td align="center" height="30" style="font-size:14px;">解梦分类：<a href="./?q=%C9%FA%BB%EE%C6%AA">生活</a> <a href="./?q=%CC%EC%CF%F3%C6%AA">天象</a> <a href="./?q=%C9%BD%B5%D8%C6%AA">山地</a> <a href="./?q=%C6%F7%CE%EF%C6%AA">器物</a> <a href="./?q=%BD%A8%D6%FE%C6%AA">建筑</a> <a href="./?q=%CE%C4%BB%AF%C6%AA">文化</a> <a href="./?q=%D6%B2%CE%EF%C6%AA">植物</a> <a href="./?q=%B6%AF%CE%EF%C6%AA">动物</a> <a href="./?q=%C9%F1%B9%ED%C6%AA">神鬼</a> <a href="./?q=%C8%CB%C9%ED%C6%AA">人身</a> <a href="./?q=%C7%E9%B0%AE%C6%AA">情爱</a> <a href="./?q=%C6%E4%CB%FC%C6%AA">其他</a></td></tr></table>
